...
class Routes(
  ...
  def documentation = List(
    ("""GET""", this.prefix, """controllers.Application.index(request:Request)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """actor""", """controllers.Application.index(request:Request)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """actor/detail/""" + "$" + """id<[^/]+>""", """controllers.Application.detail(request:Request, id:Long)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """actor/create""", """controllers.Application.create(request:Request)"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """actor/save""", """controllers.Application.save(request:Request)"""),
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """actor/delete/""" + "$" + """id<[^/]+>""", """controllers.Application.delete(request:Request, id:Long)"""),
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """init""", """controllers.Application.init(request:Request)"""),
  ...
  private[this] lazy val controllers_Application_index0_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.index(fakeValue[play.mvc.Http.Request]),
  ...
  private[this] lazy val controllers_Application_detail2_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.detail(fakeValue[play.mvc.Http.Request], fakeValue[Long]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "detail",
  ...
  private[this] lazy val controllers_Application_create3_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.create(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "create",
  ...
  private[this] lazy val controllers_Application_save4_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.save(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "save",
  ...
  private[this] lazy val controllers_Application_delete5_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.delete(fakeValue[play.mvc.Http.Request], fakeValue[Long]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "delete",
  ...
  private[this] lazy val controllers_Application_init6_invoker = createInvoker(
    ...
    (req:play.mvc.Http.Request) =>
      Application_0.init(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "init",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Application_index0_route(params@_) =>
      call { 
        controllers_Application_index0_invoker.call(
          req => Application_0.index(req))
      }
  
    // @LINE:6
    case controllers_Application_index1_route(params@_) =>
      call { 
        controllers_Application_index1_invoker.call(
          req => Application_0.index(req))
      }
    ...
    case controllers_Application_detail2_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_detail2_invoker.call(
          req => Application_0.detail(req, id))
      }
  
    // @LINE:8
    case controllers_Application_create3_route(params@_) =>
      call { 
        controllers_Application_create3_invoker.call(
          req => Application_0.create(req))
      }
  
    // @LINE:9
    case controllers_Application_save4_route(params@_) =>
      call { 
        controllers_Application_save4_invoker.call(
          req => Application_0.save(req))
      }
  
    // @LINE:10
    case controllers_Application_delete5_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_Application_delete5_invoker.call(
          req => Application_0.delete(req, id))
      }
  
    // @LINE:12
    case controllers_Application_init6_route(params@_) =>
      call { 
        controllers_Application_init6_invoker.call(
          req => Application_0.init(req))
      }
