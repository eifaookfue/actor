...
public class Actor extends Model {
	...
	public static Finder<Long, Actor> finder = new Finder<>(Actor.class);
	...
	public String toString() {
		return "Actor [id=" + id + ", name=" + name + ", height=" + height + ", blood=" + blood + ", birthday="
				+ birthday + ", birthplaceId=" + birthplaceId + ", updateAt=" + updateAt + "]";
	}
